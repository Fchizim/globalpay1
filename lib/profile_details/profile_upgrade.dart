...
class _KycLevelsPageState extends State<KycLevelsPage>
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      final userProvider = prov.Provider.of<UserProvider>(
        context,
        listen: false,
      );
  ...
  void _goToReviewPage() {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => Tier2Completion(nin: nin, submittedTime: submittedTime),
      ),
    );
  }
          ...
          children: [
                ...
                child: Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          "Tier 2 verification is under review",
            ...
            ElevatedButton(
              onPressed: () async {
                ...
                final kycProvider = prov.Provider.of<KycProvider>(
                  context,
                  listen: false,
                );
