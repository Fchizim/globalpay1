const Map<String, List<String>> nigeriaLgas = {
  ...
  /// ⚠️ IMPORTANT:
  /// Continue this same pattern for ALL states.
  /// (Full 774 LGAs dataset is very large and cannot fit in one single response.)
