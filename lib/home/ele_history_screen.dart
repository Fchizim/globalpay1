...
class EleHistoryScreen extends StatefulWidget {
  const EleHistoryScreen({super.key});

  @override
  State<EleHistoryScreen> createState() => _EleHistoryScreenState();
}

class _EleHistoryScreenState extends State<EleHistoryScreen> {
    ...
    return Scaffold(
      ...
      body: _isLoading
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          const SizedBox(height: 12),
          Text('No electricity transactions yet',
              ...
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (_) => TransactionDetailScreen(
                    ...
                    ref:             ref,
                    newBalance:      double.tryParse(trx['new_balance']?.toString() ?? '0') ?? 0.0,
                    action:          action,
                    eleToken:        trx['ele_token']?.toString(),
                    eleUnits:        trx['ele_units']?.toString(),
                    eleMeter:        trx['ele_meter']?.toString(),
              ...
              child: Row(children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(network.isNotEmpty ? network : 'Electricity',
                          style: TextStyle(
                              color: textColor,
